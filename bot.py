...
TOKEN = '6669938750:AAEkkIn0h6IPocHF-4W-kVjmTN3o1yPyfVw'
...
def text_messages(message):
    bot.send_message(message.from_user.id, 'Choise which language you want to translate', reply_markup=buttons.language_buttons())
